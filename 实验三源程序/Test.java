...
public class Test{
	public static void main(String args[]) {
		...
		Course advanced_mathematics =new Course(1,"advanced_mathematics","building1class1","7:50","Wang");
		Course discrete_mathematics =new Course(2,"discrete_mathematics","building1class2","9:40","Zhang");
		Course database =new Course(3,"database","building3class2","13：30","Li");
		Course javaProgramming =new Course(4,"javaProgramming","building2class1","4:05","Chen");
